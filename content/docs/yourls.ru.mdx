...
Параметр `signature` соответствует вашему **API Token S.EE**.

Создать и управлять API Token можно здесь:

https://s.ee/user/developers/

API Token привязан к авторизованному пользователю и наследует те же права и ограничения, что и аккаунт.
...
|----------|----------|-------------|
| `signature` | Да | Ваш API Token S.EE |

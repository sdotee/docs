...
<div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginTop: '8px' }}>
  <a href="https://s.ee/ios" target="_blank" rel="noopener noreferrer">
    <img src="https://assets.seecdn.com/static/app-store-badge.svg" alt="Télécharger sur l’App Store" height="40" />
  </a>
  <a href="https://s.ee/android" target="_blank" rel="noopener noreferrer">
    <img src="https://assets.seecdn.com/static/google-play-badge.svg" alt="Télécharger sur Google Play" height="40" />
  </a>
</div>
...
4. Ouvrez l’application, accédez à **Paramètres**, saisissez votre clé API puis appuyez sur **Vérifier**

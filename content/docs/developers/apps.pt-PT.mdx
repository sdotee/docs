...
- Limites de velocidade para API Calls, Links, Text Shares, Uploads e QR Codes
...
4. Abra a aplicação, vá a **Settings**, introduza a sua chave de API e toque em **Verify**

...
- Edite ou exclua links existentes
...
- Limites de taxa para API Calls, Links, Text Shares, Uploads e QR Codes
- Contadores de uso diário e mensal

### Configurações

- Configuração de URL base para instâncias self-hosted
...
4. Abra o aplicativo, vá para **Settings**, digite sua chave de API e toque em **Verify**
